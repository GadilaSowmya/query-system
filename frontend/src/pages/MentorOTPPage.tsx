                ...
                if (type === 'login') {
                    ...
                    try {
                        ...
                        const mentorData = {
                            ...
                            email: email,
                            phone: mentor.phone || '',
                            addressLine: mentor.addressLine || '',
                            city: mentor.city || '',
                            state: mentor.state || '',
                        ...
                        const mentorData = {
                            ...
                            addressLine: data.addressLine || data.mentor?.addressLine || '',
                            city: data.city || data.mentor?.city || '',
                            state: data.state || data.mentor?.state || '',
                            pinCode: data.pinCode || data.mentor?.pinCode || '',
                            country: data.country || data.mentor?.country || '',
